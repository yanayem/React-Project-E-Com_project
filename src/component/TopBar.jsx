...
function TopBar(){
  ...
  return(
    <div className="container">
      <div className=" top_bar row">
        ...
        <img className=" float-start pe-2" src="/src/assets/🌟.png" alt="star" />
        <p className=""> Get 5% Off your first order,<span className="ps-2" style={{ color: "#FC8A06" }}>Promo: ORDER5</span></p>
      </div>
      <div className="right_topbar col-sm-7 row">
        <div className="top_bar_address col-sm-7 pt-3">
          <img className="float-start" src="/src/assets/Location.png" alt="" />
          <p>Regent Street, A4, A4201, London <a href="">Change Location</a></p>
        </div>
  ...
  <div className="item_text col-sm-4 d-flex justify-content-center align-items-center" style={{
